...
public class Bicycling {
    ...
    public Bicycling(Long exerciseid, Long speed, Long distancecovered, Long caloriesburnt, String exercisetype, String exercisedate, String exerciseat, String exercisetime) {
