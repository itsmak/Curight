...
public class Softball {
    ...
    public Softball(Long exerciseid, Long speed, Long distancecovered, Long caloriesburnt, String exercisetype, String exercisedate, String exerciseat, String exercisetime) {
