...
public class POST_UPDATE_CLASS {
    ...
    public POST_UPDATE_CLASS(String userid, String vaccineactivityid, String vaccinedate, String comments, String doctorname, String reminder1, String reminder2) {
        this.userid = userid;
