...
public class FrisbeeAdapter  extends RecyclerView.Adapter<FrisbeeAdapter.MyViewHolder> {

    ProgressDialog progressDialog;
    Frisbee walking;
    private ArrayList<Frisbee> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public FrisbeeAdapter(Context context,int  rowlayout,ArrayList<Frisbee> arrayList) {
        mContext = context;
    ...
    @Override
    public FrisbeeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                       int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new FrisbeeAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final FrisbeeAdapter.MyViewHolder holder, final int position) {
