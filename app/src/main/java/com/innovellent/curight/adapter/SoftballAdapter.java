...
public class SoftballAdapter extends RecyclerView.Adapter<SoftballAdapter.MyViewHolder> {

    Softball runing;
    ProgressDialog progressDialog;
    private ArrayList<Softball> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public SoftballAdapter(Context context,int  rowlayout,ArrayList<Softball> arrayList) {
        mContext = context;
    ...
    @Override
    public SoftballAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new SoftballAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final SoftballAdapter.MyViewHolder holder, final int position) {
