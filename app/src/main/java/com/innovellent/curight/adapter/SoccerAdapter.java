...
public class SoccerAdapter extends RecyclerView.Adapter<SoccerAdapter.MyViewHolder> {
    ...
    private ArrayList<Soccer> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public SoccerAdapter(Context context,int  rowlayout,ArrayList<Soccer> arrayList) {
        mContext = context;
    ...
    @Override
    public SoccerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new SoccerAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final SoccerAdapter.MyViewHolder holder, final int position) {
