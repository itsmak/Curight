...
public class YogaAdapter extends RecyclerView.Adapter<YogaAdapter.MyViewHolder> {
    ...
    private ArrayList<Yoga> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public YogaAdapter(Context context,int  rowlayout,ArrayList<Yoga> arrayList) {
        mContext = context;
    ...
    @Override
    public YogaAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new YogaAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final YogaAdapter.MyViewHolder holder, final int position) {
