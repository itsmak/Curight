...
public class TennisAdapter extends RecyclerView.Adapter<TennisAdapter.MyViewHolder> {

    Tennis runing;
    ProgressDialog progressDialog;
    private ArrayList<Tennis> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public TennisAdapter(Context context,int  rowlayout,ArrayList<Tennis> arrayList) {
        mContext = context;
    ...
    @Override
    public TennisAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new TennisAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final TennisAdapter.MyViewHolder holder, final int position) {
