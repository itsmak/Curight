...
public class RowingAdapter  extends RecyclerView.Adapter<RowingAdapter.MyViewHolder> {

    Rowing runing;
    ProgressDialog progressDialog;
    private ArrayList<Rowing> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public RowingAdapter(Context context,int  rowlayout,ArrayList<Rowing> arrayList) {
        mContext = context;
    ...
    @Override
    public RowingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new RowingAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RowingAdapter.MyViewHolder holder, final int position) {
