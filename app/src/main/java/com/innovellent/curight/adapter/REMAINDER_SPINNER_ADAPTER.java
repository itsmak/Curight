...
public class REMAINDER_SPINNER_ADAPTER extends BaseAdapter {

    Context context;
    LayoutInflater inflter;
    private ArrayList<PROFILE> spinner2;

    public REMAINDER_SPINNER_ADAPTER(Context context, ArrayList<PROFILE> spinner2) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.remainder_customspinner, null);
