...
public class WeightliftingAdapter extends RecyclerView.Adapter<WeightliftingAdapter.MyViewHolder> {

    Weightlifting runing;
    ProgressDialog progressDialog;
    private ArrayList<Weightlifting> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public WeightliftingAdapter(Context context,int  rowlayout,ArrayList<Weightlifting> arrayList) {
        mContext = context;
    ...
    @Override
    public WeightliftingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new WeightliftingAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final WeightliftingAdapter.MyViewHolder holder, final int position) {
