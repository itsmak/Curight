...
public class RunningAdapter  extends RecyclerView.Adapter<RunningAdapter.MyViewHolder> {

    Running runing;
    ProgressDialog progressDialog;
    private ArrayList<Running> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;

    public RunningAdapter(Context context,int rowlayout,ArrayList<Running> arrayList) {
        mContext = context;
    ...
    @Override
    public RunningAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new RunningAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RunningAdapter.MyViewHolder holder, final int position) {
