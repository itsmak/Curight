...
public class TrailBikingAdapter extends RecyclerView.Adapter<TrailBikingAdapter.MyViewHolder> {

    TrailBiking runing;
    ProgressDialog progressDialog;
    private ArrayList<TrailBiking> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public TrailBikingAdapter(Context context,int  rowlayout,ArrayList<TrailBiking> arrayList) {
        mContext = context;
    ...
    @Override
    public TrailBikingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new TrailBikingAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final TrailBikingAdapter.MyViewHolder holder, final int position) {
