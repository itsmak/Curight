...
public class RacquetballAdapter  extends RecyclerView.Adapter<RacquetballAdapter.MyViewHolder> {

    Racquetball runing;
    ProgressDialog progressDialog;
    private ArrayList<Racquetball> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public RacquetballAdapter(Context context,int  rowlayout,ArrayList<Racquetball> arrayList) {
        mContext = context;
    ...
    @Override
    public RacquetballAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new RacquetballAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RacquetballAdapter.MyViewHolder holder, final int position) {
