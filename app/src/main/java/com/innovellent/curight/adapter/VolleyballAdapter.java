...
public class VolleyballAdapter extends RecyclerView.Adapter<VolleyballAdapter.MyViewHolder> {

Volleyball runing;
ProgressDialog progressDialog;
private ArrayList<Volleyball> arrayList = new ArrayList<>();
private Context mContext;
private String state;
private int rowlayout;
private LinearLayout llAmount;

    public VolleyballAdapter(Context context, int  rowlayout, ArrayList<Volleyball> arrayList) {
        mContext = context;
    ...
    @Override
    public VolleyballAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new VolleyballAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final VolleyballAdapter.MyViewHolder holder, final int position) {
