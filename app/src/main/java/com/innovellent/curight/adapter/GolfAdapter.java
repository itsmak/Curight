...
public class GolfAdapter extends RecyclerView.Adapter<GolfAdapter.MyViewHolder> {

    Golf runing;
    ProgressDialog progressDialog;
    private ArrayList<Golf> arrayList = new ArrayList<>();
    private Context mContext;
    private String state;
    private int rowlayout;
    private LinearLayout llAmount;

    public GolfAdapter(Context context,int  rowlayout,ArrayList<Golf> arrayList) {
        mContext = context;
    ...
    @Override
    public GolfAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowlayout, parent, false);
        return new GolfAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final GolfAdapter.MyViewHolder holder, final int position) {
